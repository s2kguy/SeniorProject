...
function (req, email, password, done) {
    ...
    req.checkBody('phoneNumber', 'Phone Number is required and must have 10 digits')
        .notEmpty().isLength({ min: 10, max: 10 });
    ...
    req.checkBody('confirmPassword', 'Your passwords do not match!').equals(password);
    console.log('Password: ' + password + '\nConfirm PW: ' + confirmPass);
